...
Для выполнения матчинга написаны макросы (letvar), (forthis) и (/.). Макрос (/.) использует функцию (traverse) для обхода дерева и применяет к каждой ноде функцию (forthis) для замены согласно указанным в теле правилам.